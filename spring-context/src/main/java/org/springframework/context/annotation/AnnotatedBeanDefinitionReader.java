...
public class AnnotatedBeanDefinitionReader {
	...
	/**
	 * 这里的 BeanDefinitionRegistry register 是通过在 AnnotationConfigApplicationContext
	 * 的构造方法中传进来的 this
	 * 由此说明 AnnotationConfigApplicationContext 是一个 BeanDefinitionRegistry 类型的类
	 * 何以证明我们可以看到 AnnotationConfigApplicationContext 的类关系
	...
	<T> void doRegisterBean(Class<T> annotatedClass, @Nullable Supplier<T> instanceSupplier, @Nullable String name,
		...
		// 把上述的数据结构注册给 registry
		// registry 就是 AnnotationConfigApplicationContext
		// AnnotationConfigApplicationContext 在初始化的时候通过调用父类构造方法
